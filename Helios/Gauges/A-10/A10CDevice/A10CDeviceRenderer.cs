...
namespace GadrocsWorkshop.Helios.Gauges.A10C
{
    ...
    class A10CDeviceRenderer : HeliosVisualRenderer
    {
        ...
        {
            A10CDevice _A10Cdevice = Visual as A10CDevice;
        ...
        protected override void OnRefresh()
        {
            ...
            if (_A10Cdevice != null)
            {
                _bezelRectangle = new Rect(0, 0, _A10Cdevice.Width, _A10Cdevice.Height);

                _bezel = CreateImageBrush(_A10Cdevice.BezelImage);
            }
            else
            {
                _bezel = null;
