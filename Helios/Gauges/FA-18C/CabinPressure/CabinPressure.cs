...
{ 
    ...
    [HeliosControl("Helios.FA18C.cabinPressure", "Cabin Pressure", "F/A-18C Gauges", typeof(GaugeRenderer))]
    public class cabinPressure : CabinPressure
    {
            ...
            : base()
        {
            ...
            Components.Insert(1, new GaugeImage("{Helios}/Gauges/FA-18C/CabinPressure/Cabin_Pressure_Faceplate.png", new Rect(32d, 38d, 300, 300)));  // add in a new faceplate
