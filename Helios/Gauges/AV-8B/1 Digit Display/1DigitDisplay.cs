...
namespace GadrocsWorkshop.Helios.Gauges.AV8B.OneDigitDisplay
{
    ...
    [HeliosControl("Helios.AV8B.OneDigitDisplay", "One Digit Display", "AV-8B Gauges", typeof(GaugeRenderer))]
