...
namespace GadrocsWorkshop.Helios.Gauges.AV8B.FuelPanel
{
    ...
    [HeliosControl("Helios.AV8B.FuelPanel.FourDigitDisplay", "Four Digit Display", "AV-8B", typeof(GaugeRenderer))]
    public class FourDigitDisplay : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{Helios}/Gauges/AV-8B/FuelPanel/4 Digit Display/digit_faceplate.xaml", new Rect(0d, 0d, 275d, 100d)));
