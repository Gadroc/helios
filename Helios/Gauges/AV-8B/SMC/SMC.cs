...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    class SMC_AV8B: AV8BDevice
    {
            ...
            : base("SMC", new Size(1231, 470))
        {
            ...
            AddButton("Station 2", 486, 392, new Size(50, 50), "Station 2 Button");
            AddButton("Station 3", 586, 392, new Size(50, 50), "Station 3 Button");
            AddButton("Station 4", 688, 392, new Size(50, 50), "Station 4 Button");
            AddButton("Station 5", 788, 392, new Size(50, 50), "Station 5 Button");
            AddButton("Station 6", 886, 392, new Size(50, 50), "Station 6 Button");
            AddButton("Station 7", 988, 392, new Size(50, 50), "Station 7 Button");

            AddIndicator("Station 1 Selected", 385, 330, new Size(47, 41), "Select station 1");
            AddIndicator("Station 2 Selected", 488, 330, new Size(47, 41), "Select station 2"); 
            AddIndicator("Station 3 Selected", 588, 330, new Size(47, 41), "Select station 3");
            AddIndicator("Station 4 Selected", 687, 330, new Size(47, 41), "Select station 4");
            AddIndicator("Station 5 Selected", 784, 330, new Size(47, 41), "Select station 5");
            AddIndicator("Station 6 Selected", 886, 330, new Size(47, 41), "Select station 6");
            AddIndicator("Station 7 Selected", 988, 330, new Size(47, 41), "Select station 7");
