...
namespace GadrocsWorkshop.Helios.Gauges.AV8B.FiveDigitDisplay
{
    ...
    [HeliosControl("Helios.AV8B.FiveDigitDisplay", "Five Digit Display", "AV-8B Gauges", typeof(GaugeRenderer))]
