...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.ADI", "ADI Gauge", "AV-8B Gauges", typeof(GaugeRenderer))]
    public class ADI : BaseGauge
    {
            ...
            : base("Flight Instruments", new Size(350, 350))
        {
            ...
            //Components.Add(new GaugeImage("{AV-8B}/Images/WQHD/Panel/crystal_reflection_round.png", new Rect(44d, 33d, 260d, 260d)));
