...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.F14B
{
    ...
    using GadrocsWorkshop.Helios.Interfaces.DCS.F14B.Functions;
    ...
    [HeliosInterface("Helios.F14B", "DCS F-14B RIO", typeof(F14BRIOInterfaceEditor), typeof(UniqueHeliosInterfaceFactory))]
    public class F14BRIOInterface : BaseUDPInterface
    {
        ...
        public F14BRIOInterface()
            : base("DCS F-14B RIO")        {
            DCSConfigurator config = new DCSConfigurator("DCSF14B", DCSPath);
            config.ExportConfigPath = "Config\\Export";
            config.ExportFunctionsPath = "pack://application:,,,/Helios;component/Interfaces/DCS/F14B - RIO/ExportFunctions.lua";
            Port = config.Port;
