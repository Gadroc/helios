...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.AV8B.Functions
{
    ...
    public class Digits2Display : NetworkFunction
    {
            ...
            : base(sourceInterface)
        {
            ...
            _two_digit_display = new HeliosValue(sourceInterface, BindingValue.Empty, argId, device, name, "", BindingValueUnits.Numeric);
