...
-- It is a stub that provides infrastructure and invokes 
-- aircraft specific export files arranged in directories
--
...
Helios.log.write(thisScript,"Loading options from - " .. lfs.writedir() .. "config\\options.lua")
