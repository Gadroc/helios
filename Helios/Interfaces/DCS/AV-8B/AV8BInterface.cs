...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.AV8B
{
    ...
    public class AV8BInterface : BaseUDPInterface
    {
        ...
        private const string MPCD_LEFT = "25";
        private const string MPCD_RIGHT = "26";
        private const string FLIGHTCONTROLS = "27";
        private const string SMC = "28";
        private const string EWS = "29";
        private const string CBTSYST = "30";
        private const string TVWPNS = "31";
        private const string LTEXT = "32";
        private const string LTINT = "33";
        private const string LTWCA = "34";
        private const string ECS = "35";
        private const string HYDRAULIC = "36";
        private const string NETWORKINTERFACE = "37";
        private const string ANVIS9 = "38";
        #endregion
            ...
            : base("DCS AV8B")
        {
            ...
            //AddFunction(new ScaledNetworkValue(this, "76", engineFanSpeedScale, "Left Engine", "Fan Speed", "Fan speed of engine.", "0-100", BindingValueUnits.RPMPercent));
            //AddFunction(new ScaledNetworkValue(this, "77", engineFanSpeedScale, "Right Engine", "Fan Speed", "Fan speed of engine.", "0-100", BindingValueUnits.RPMPercent));
            ...
            //AddFunction(new ScaledNetworkValue(this, "70", engineTempScale, "Left Engine", "Interstage Turbine Temperature", "", "", BindingValueUnits.Celsius));
            //AddFunction(new ScaledNetworkValue(this, "73", engineTempScale, "Right Engine", "Interstage Turbine Temperature", "", "", BindingValueUnits.Celsius));
            ...
            //AddFunction(new ScaledNetworkValue(this, "48", airspeedScale, "IAS", "Airspeed", "Current indicated air speed of the aircraft.", "", BindingValueUnits.Knots));
            ...
            //vviScale.Add(new CalibrationPointDouble(0.29d, 1000d));
            //vviScale.Add(new CalibrationPointDouble(0.5d, 2000d));
            //AddFunction(new ScaledNetworkValue(this, "12", vviScale, "VVI", "Vertical Velocity", "Current vertical velocity of the aircraft.", "", BindingValueUnits.FeetPerMinute));
            ...
            #region Left MCFD
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_1, "200", "Left MFCD", "OSB1"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_2, "201", "Left MFCD", "OSB2"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_3, "202", "Left MFCD", "OSB3"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_4, "203", "Left MFCD", "OSB4"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_5, "204", "Left MFCD", "OSB5"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_6, "205", "Left MFCD", "OSB6"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_7, "206", "Left MFCD", "OSB7"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_8, "207", "Left MFCD", "OSB8"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_9, "208", "Left MFCD", "OSB9"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_10, "209", "Left MFCD", "OSB10"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_11, "210", "Left MFCD", "OSB11"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_12, "211", "Left MFCD", "OSB12"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_13, "212", "Left MFCD", "OSB13"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_14, "213", "Left MFCD", "OSB14"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_15, "214", "Left MFCD", "OSB15"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_16, "215", "Left MFCD", "OSB16"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_17, "216", "Left MFCD", "OSB17"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_18, "217", "Left MFCD", "OSB18"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_19, "218", "Left MFCD", "OSB19"));
            AddFunction(new PushButton(this, MPCD_LEFT, BUTTON_20, "219", "Left MFCD", "OSB20"));
            AddFunction(new Rocker(this, MPCD_LEFT, BUTTON_21, BUTTON_22, BUTTON_23, BUTTON_23, "320", "Left MFCD", "Moving Map Scale", true));
            AddFunction(new Rocker(this, MPCD_LEFT, BUTTON_24, BUTTON_25, BUTTON_26, BUTTON_26, "321", "Left MFCD", "Backlight", true));
            AddFunction(new Rocker(this, MPCD_LEFT, BUTTON_27, BUTTON_27, BUTTON_29, BUTTON_29, "322", "Left MFCD", "Brightness", true));
            AddFunction(new Rocker(this, MPCD_LEFT, BUTTON_30, BUTTON_31, BUTTON_32, BUTTON_32, "323", "Left MFCD", "Contrast", true));
            AddFunction(new Rocker(this, MPCD_LEFT, BUTTON_33, BUTTON_34, BUTTON_35, BUTTON_35, "324", "Left MFCD", "Entity Level", false));
            AddFunction(Switch.CreateThreeWaySwitch(this, MPCD_LEFT, BUTTON_36, "220", "0.2", "Day", "0.1", "Night", "0.0", "Off", "Left MFCD", "Day/Night/Off", "%0.1f"));
            #endregion

            #region Right MCFD
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_1, "326", "Right MFCD", "OSB1"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_2, "327", "Right MFCD", "OSB2"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_3, "328", "Right MFCD", "OSB3"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_4, "329", "Right MFCD", "OSB4"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_5, "330", "Right MFCD", "OSB5"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_6, "331", "Right MFCD", "OSB6"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_7, "332", "Right MFCD", "OSB7"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_8, "333", "Right MFCD", "OSB8"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_9, "334", "Right MFCD", "OSB9"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_10, "335", "Right MFCD", "OSB10"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_11, "336", "Right MFCD", "OSB11"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_12, "337", "Right MFCD", "OSB12"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_13, "338", "Right MFCD", "OSB13"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_14, "339", "Right MFCD", "OSB14"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_15, "340", "Right MFCD", "OSB15"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_16, "341", "Right MFCD", "OSB16"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_17, "342", "Right MFCD", "OSB17"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_18, "343", "Right MFCD", "OSB18"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_19, "344", "Right MFCD", "OSB19"));
            AddFunction(new PushButton(this, MPCD_RIGHT, BUTTON_20, "345", "Right MFCD", "OSB20"));
            AddFunction(new Rocker(this, MPCD_RIGHT, BUTTON_21, BUTTON_22, BUTTON_23, BUTTON_23, "346", "Right MFCD", "Moving Map Scale", true));
            AddFunction(new Rocker(this, MPCD_RIGHT, BUTTON_24, BUTTON_25, BUTTON_26, BUTTON_26, "347", "Right MFCD", "Backlight", true));
            AddFunction(new Rocker(this, MPCD_RIGHT, BUTTON_27, BUTTON_27, BUTTON_29, BUTTON_29, "348", "Right MFCD", "Brightness", true));
            AddFunction(new Rocker(this, MPCD_RIGHT, BUTTON_30, BUTTON_31, BUTTON_32, BUTTON_32, "349", "Right MFCD", "Contrast", true));
            AddFunction(new Rocker(this, MPCD_RIGHT, BUTTON_33, BUTTON_34, BUTTON_35, BUTTON_35, "350", "Right MFCD", "Entity Level", false));
            AddFunction(Switch.CreateThreeWaySwitch(this, MPCD_RIGHT, BUTTON_36, "351", "0.2", "Day", "0.1", "Night", "0.0", "Off", "Right MFCD", "Day/Night/Off", "%0.1f"));
            #endregion

            #region UFC
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_1, "302", "UFC", "1"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_2, "303", "UFC", "2/N"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_3, "304", "UFC", "3"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_4, "306", "UFC", "4/W"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_5, "307", "UFC", "5"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_6, "308", "UFC", "6/E"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_7, "310", "UFC", "7"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_8, "311", "UFC", "8/S"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_9, "310", "UFC", "9"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_10, "315", "UFC", "0"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_11, "316", "UFC", "."));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_12, "313", "UFC", "-"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_13, "314", "UFC", "Enter"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_15, "305", "UFC", "Clear"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_14, "294", "UFC", "Timer"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_16, "324", "UFC", "Altitude"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_17, "318", "UFC", "IFF"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "319", "UFC", "TACAN"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "320", "UFC", "All Weather Landing"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "317", "UFC", "On/Off"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "325", "UFC", "Emmission Control"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "296", "UFC", "Target of Opportunity"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "322", "UFC", "Waypoint Overfly"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "321", "UFC", "Weapons"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "323", "UFC", "RADAR Beacon"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "297", "UFC", "I/P"));
            AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "309", "UFC", "Save"));
            //AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "319", "UFC", "TACAN"));
            //AddFunction(new PushButton(this, UFCCONTROL, BUTTON_18, "319", "UFC", "TACAN"));
            //AddFunction(new Rocker(this, UFCCONTROL, BUTTON_20, BUTTON_21, BUTTON_20, BUTTON_21, "405", "UFC", "Steer", true));
            //AddFunction(new Rocker(this, UFCCONTROL, BUTTON_22, BUTTON_23, BUTTON_22, BUTTON_23, "406", "UFC", "Data", true));
            //AddFunction(new Rocker(this, UFCCONTROL, BUTTON_24, BUTTON_25, BUTTON_24, BUTTON_25, "407", "UFC", "Select", true));
            //AddFunction(new Rocker(this, UFCCONTROL, BUTTON_26, BUTTON_27, BUTTON_26, BUTTON_27, "408", "UFC", "Adjust Depressible Pipper", true));
            //AddFunction(new Rocker(this, UFCCONTROL, BUTTON_28, BUTTON_29, BUTTON_28, BUTTON_29, "409", "UFC", "HUD Brightness", false));
            //AddFunction(new PushButton(this, UFCCONTROL, BUTTON_30, "531", "UFC", "FWD"));
            //AddFunction(new PushButton(this, UFCCONTROL, BUTTON_31, "532", "UFC", "MID"));
            //AddFunction(new PushButton(this, UFCCONTROL, BUTTON_32, "533", "UFC", "AFT"));
            AddFunction(new PushButton(this, LTWCA, BUTTON_1, "198", "UFC", "Master Caution"));
            AddFunction(new PushButton(this, LTWCA, BUTTON_2, "199", "UFC", "Master Warning"));
            //AddFunction(new FlagValue(this, "404", "UFC", "Master Warning Indicator", "Indicator lamp on master caution button."));
            #endregion

            #region ODU
            AddFunction(new PushButton(this, ODUCONTROL, BUTTON_1, "250", "ODU", "1"));
            AddFunction(new PushButton(this, ODUCONTROL, BUTTON_2, "251", "ODU", "2"));
            AddFunction(new PushButton(this, ODUCONTROL, BUTTON_3, "252", "ODU", "3"));
            AddFunction(new PushButton(this, ODUCONTROL, BUTTON_4, "253", "ODU", "4"));
            AddFunction(new PushButton(this, ODUCONTROL, BUTTON_5, "254", "ODU", "5"));
            #endregion

            #region Indicators
            AddFunction(new FlagValue(this, "196", "Caution/Warning", "Master Caution", "Main Master Caution indicator on the UFC"));
            AddFunction(new FlagValue(this, "197", "Caution/Warning", "Master Warning", "Main Master warning indicator on the UFC"));
            AddFunction(new FlagValue(this, "276", "Master Modes", "Unknown 276", ""));
            AddFunction(new FlagValue(this, "277", "Master Modes", "Unknown 277", ""));
            AddFunction(new FlagValue(this, "278", "Master Modes", "Unknown 278", ""));
            AddFunction(new FlagValue(this, "279", "Master Modes", "Unknown 279", ""));
            AddFunction(new FlagValue(this, "281", "Master Modes", "A/G Master Mode Indicator", ""));
            AddFunction(new FlagValue(this, "283", "Master Modes", "Nav Master Mode Indicator", ""));
            AddFunction(new FlagValue(this, "285", "Master Modes", "VSTOL Master Mode Indicator", ""));
            AddFunction(new FlagValue(this, "326", "Master Caution Lights", "L Fuel Indicator", ""));
            AddFunction(new FlagValue(this, "327", "Master Caution Lights", "R fuel Indicator", ""));
            AddFunction(new FlagValue(this, "328", "Master Caution Lights", "15 Sec Indicator", "JPT above normal lift rating"));
            AddFunction(new FlagValue(this, "329", "Master Caution Lights", "MFS", "Manual Fuel System on"));
            AddFunction(new FlagValue(this, "330", "Master Caution Lights", "Bingo Warning Light", ""));
            AddFunction(new FlagValue(this, "331", "Master Caution Lights", "H2O", "Less than 15 secs water left"));
            AddFunction(new FlagValue(this, "334", "Master Warning Lights", "Fire", "Fire in engine"));
            AddFunction(new FlagValue(this, "335", "Master Warning Lights", "LAW", "Low alt warning"));
            AddFunction(new FlagValue(this, "336", "Master Warning Lights", "Flaps Warning Light", "Flap System Failure"));
            AddFunction(new FlagValue(this, "337", "Master Warning Lights", "L Tank", "Left tank over pressure"));
            AddFunction(new FlagValue(this, "338", "Master Warning Lights", "R Tank", "Right Tank Over pressure"));
            AddFunction(new FlagValue(this, "339", "Master Warning Lights", "HYD", "Both hydraulics failed"));
            AddFunction(new FlagValue(this, "340", "Master Warning Lights", "Gear Warning Light", ""));
            AddFunction(new FlagValue(this, "341", "Master Warning Lights", "OT", "Over temp JPT"));
            AddFunction(new FlagValue(this, "342", "Master Warning Lights", "JPTL", "JPTL Control Fail"));
            AddFunction(new FlagValue(this, "343", "Master Warning Lights", "EFC", "All Digital engine controls failed"));
            AddFunction(new FlagValue(this, "344", "Master Warning Lights", "GEN", "AC Generator offline"));
            AddFunction(new FlagValue(this, "446", "Landing Gear", "Gear - Possibly the handle?", ""));
            AddFunction(new FlagValue(this, "451", "Refueling", "Left Tank", "Left fuel tank refueling status"));
            AddFunction(new FlagValue(this, "452", "Refueling", "Ready Refueling", "A2A Refueling Status"));
            AddFunction(new FlagValue(this, "453", "Refueling", "Right Tank", "Right fuel tank refueling status"));
            AddFunction(new FlagValue(this, "462", "Landing Gear", "Nose L", ""));
            AddFunction(new FlagValue(this, "463", "Landing Gear", "Nose", ""));
            AddFunction(new FlagValue(this, "464", "Landing Gear", "Left L", ""));
            AddFunction(new FlagValue(this, "465", "Landing Gear", "Left", ""));
            AddFunction(new FlagValue(this, "466", "Landing Gear", "Right L", ""));
            AddFunction(new FlagValue(this, "467", "Landing Gear", "Right", ""));
            AddFunction(new FlagValue(this, "468", "Landing Gear", "Main L", ""));
            AddFunction(new FlagValue(this, "469", "Landing Gear", "Main", ""));
            AddFunction(new FlagValue(this, "560", "Caution Lights", "AFC", "AFC malfunction or AFC deselected"));
            AddFunction(new FlagValue(this, "561", "Caution Lights", "AFT BAY", "Aft avionics bay ECS failed"));
            AddFunction(new FlagValue(this, "562", "Caution Lights", "APU GEN", "APU selected and emergency generator failed"));
            AddFunction(new FlagValue(this, "563", "Caution Lights", "AUT FLP", "Auto flap mode or ADC failed"));
            AddFunction(new FlagValue(this, "564", "Caution Lights", "CANOPY", "Canopy not closed and locked"));
            AddFunction(new FlagValue(this, "565", "Caution Lights", "CASTER", "Not used on Night Attack. Illuminates on light test only"));
            AddFunction(new FlagValue(this, "566", "Caution Lights", "C*AUT", "Computed delivery mode (AUTO and CCIP) not available"));
            AddFunction(new FlagValue(this, "567", "Caution Lights", "CMBT", "Combat thrust activated. Flashes after 2 ½ minutes"));
            AddFunction(new FlagValue(this, "568", "Caution Lights", "CS COOL", "Cockpit avionics cooling fan failed"));
            AddFunction(new FlagValue(this, "569", "Caution Lights", "CW NOGO", "Jammer Failure. Cannot jam CW radars"));
            AddFunction(new FlagValue(this, "570", "Caution Lights", "DC", "Main transformer-rectifier failed"));
            AddFunction(new FlagValue(this, "571", "Caution Lights", "DEP RES", "Departure resistance reduced"));
            AddFunction(new FlagValue(this, "572", "Caution Lights", "EFC", "DECU 1 or DECU 2 has failed"));
            AddFunction(new FlagValue(this, "573", "Caution Lights", "ENG EXC", "Engine overspeed, overtemperature or over g was detected"));
            AddFunction(new FlagValue(this, "574", "Caution Lights", "FLAPS 1", "Flaps 1 channel failed"));
            AddFunction(new FlagValue(this, "575", "Caution Lights", "FLAPS 2", "Flaps 2 channel failed"));
            AddFunction(new FlagValue(this, "576", "Caution Lights", "GPS", "GPS not valid"));
            AddFunction(new FlagValue(this, "577", "Caution Lights", "H2O SEL", "Over 250 knots and water switch not OFF"));
            AddFunction(new FlagValue(this, "578", "Caution Lights", "HYD 1", "HYD 1 pressure ≤ 1400 psi"));
            AddFunction(new FlagValue(this, "579", "Caution Lights", "HYD 2", "HYD 2 pressure ≤ 1400 psi"));
            AddFunction(new FlagValue(this, "580", "Caution Lights", "IFF", "Mode 4 off, not zeroized or not responding"));
            AddFunction(new FlagValue(this, "581", "Caution Lights", "INS", "INS aligning or failed"));
            AddFunction(new FlagValue(this, "582", "Caution Lights", "JMR HOT", "Jammer pod overtemp"));
            AddFunction(new FlagValue(this, "583", "Caution Lights", "LIDS", "LIDS not in correct position"));
            AddFunction(new FlagValue(this, "584", "Caution Lights", "LOAD", "Fuel asymmetry over VL limit"));
            AddFunction(new FlagValue(this, "585", "Caution Lights", "NWS", "Nosewheel Steering malfunction"));
            AddFunction(new FlagValue(this, "586", "Caution Lights", "OIL", "Oil pressure low"));
            AddFunction(new FlagValue(this, "587", "Caution Lights", "OXY", "OBOGS malfunction"));
            AddFunction(new FlagValue(this, "588", "Caution Lights", "PITCH", "Pitch stab aug off or failed"));
            AddFunction(new FlagValue(this, "589", "Caution Lights", "P NOGO", "Jammer Failure. Cannot jam Pulse-Doppler radars"));
            AddFunction(new FlagValue(this, "590", "Caution Lights", "PROP", "Fuel proportioner off or failed"));
            AddFunction(new FlagValue(this, "591", "Caution Lights", "L PUMP", "Left fuel boost pump pressure low"));
            AddFunction(new FlagValue(this, "592", "Caution Lights", "R PUMP", "Right fuel boost pump pressure low"));
            AddFunction(new FlagValue(this, "593", "Caution Lights", "ROLL", "Roll stab aug off or failed"));
            AddFunction(new FlagValue(this, "594", "Caution Lights", "SKID", "Anti-Skid System Malfunction"));
            AddFunction(new FlagValue(this, "595", "Caution Lights", "STBY TRU", "Standby TRU inoperative or off line"));
            AddFunction(new FlagValue(this, "596", "Caution Lights", "L TRANS", "Low air pressure to the left feeder tank"));
            AddFunction(new FlagValue(this, "597", "Caution Lights", "R TRANS", "Low air pressure to the right feeder tank"));
            AddFunction(new FlagValue(this, "598", "Caution Lights", "WSHLD", "Windshield hot"));
            AddFunction(new FlagValue(this, "599", "Caution Lights", "YAW", "Yaw stab aug off or failed"));
            AddFunction(new FlagValue(this, "601", "Unknown", "Unknown 601", ""));
            AddFunction(new FlagValue(this, "602", "Unknown", "Unknown 602", ""));
            AddFunction(new FlagValue(this, "603", "Unknown", "Unknown 603", ""));
            AddFunction(new FlagValue(this, "605", "Unknown", "Unknown 605", ""));
            AddFunction(new FlagValue(this, "606", "Unknown", "Unknown 606", ""));
            AddFunction(new FlagValue(this, "634", "Unknown", "Unknown 634", ""));
            #endregion
            ...
            //#region TISL Panel
            //AddFunction(new Switch(this, IFFCC, "622", new SwitchPosition[] { new SwitchPosition("0.0", "Off", BUTTON_1), new SwitchPosition("0.1", "Cage", BUTTON_1), new SwitchPosition("0.2", "Dive", BUTTON_1), new SwitchPosition("0.3", "Level Narrow Nar", BUTTON_1), new SwitchPosition("0.4", "Level Wide", BUTTON_1) }, "TISL", "Mode Select", "%0.1f"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFFCC, BUTTON_2, "623", "1", "Over 10", "0", "10-5", "-1", "Under 5", "TISL", "Slant Range", "%1d"));
            //AddFunction(new Axis(this, IFFCC, BUTTON_3, "624", 0.1d, 0.0d, 1.0d, "TISL", "Altitude above target tens of thousands of feet"));
            //AddFunction(new Axis(this, IFFCC, BUTTON_4, "626", 0.1d, 0.0d, 1.0d, "TISL", "Altitude above target thousands of feet"));
            //AddFunction(new Axis(this, IFFCC, BUTTON_5, "636", 0.05d, 0.0d, 1.0d, "TISL", "TISL Code Wheel 1", true, "%0.2f"));
            //AddFunction(new Axis(this, IFFCC, BUTTON_6, "638", 0.05d, 0.0d, 1.0d, "TISL", "TISL Code Wheel 2", true, "%0.2f"));
            //AddFunction(new Axis(this, IFFCC, BUTTON_7, "640", 0.05d, 0.0d, 1.0d, "TISL", "TISL Code Wheel 3", true, "%0.2f"));
            //AddFunction(new Axis(this, IFFCC, BUTTON_8, "642", 0.05d, 0.0d, 1.0d, "TISL", "TISL Code Wheel 4", true, "%0.2f"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFFCC, BUTTON_9, "644", "1", "TISL", "0", "Both", "-1", "Aux", "TISL", "Code Select", "%1d"));
            //AddFunction(new PushButton(this, IFFCC, BUTTON_10, "628", "TISL", "Enter"));
            //AddFunction(new PushButton(this, IFFCC, BUTTON_11, "630", "TISL", "OverTemp"));
            //AddFunction(new PushButton(this, IFFCC, BUTTON_12, "632", "TISL", "Bite"));
            //AddFunction(new PushButton(this, IFFCC, BUTTON_13, "634", "TISL", "Track"));
            //#endregion
            ...
            //AddFunction(Switch.CreateToggleSwitch(this, CPT_MECH, BUTTON_11, "787", "1", "Open", "0", "Close", "Mechanical", "Extend boarding ladder button cover", "%1d"));
            ...
            //AddFunction(new RotaryEncoder(this, TACAN, BUTTON_1, "256", 0.02, "TACAN", "Channel Selector (Tens)"));
            //AddFunction(new RotaryEncoder(this, TACAN, BUTTON_3, "257", 0.1, "TACAN", "Channel Selector (Ones X/Y)"));
            //AddFunction(Switch.CreateToggleSwitch(this, TACAN, BUTTON_5, "258", "0.87", "Ones", "0.93", "X/Y", "TACAN", "Channel Selector Mode", "%0.2f"));
            //AddFunction(new PushButton(this, TACAN, BUTTON_6, "259", "TACAN", "Test"));
            //AddFunction(new Axis(this, TACAN, BUTTON_7, "261", 0.1d, 0.0d, 1.0d, "TACAN", "Volumne"));
            //AddFunction(new Switch(this, TACAN, "262", new SwitchPosition[] { new SwitchPosition("0.0", "Off", BUTTON_8), new SwitchPosition("0.1", "Receive", BUTTON_8), new SwitchPosition("0.2", "T/R", BUTTON_8), new SwitchPosition("0.3", "A/A Receive", BUTTON_8), new SwitchPosition("0.4", "A/A T/R", BUTTON_8) }, "TACAN", "Mode", "%0.1f"));
            ...
            //#region VHF AM Radio
            //AddFunction(new Functions.VHFPresetSelector(this, VHF_AM_RADIO, BUTTON_2, BUTTON_1, "137", 0.01d, 0.00d, 0.19d, "VHF AM Radio", "Preset Channel Selector", true, "%0.3f"));
            ...
            //AddFunction(new Functions.VHFRadioEncoder1(this, VHF_AM_RADIO, BUTTON_9, BUTTON_10, "139", 0.05d, 0.15d, 0.75d, "VHF AM Radio", "1st Frequency Selector", false, "%0.2f"), true);
            //AddFunction(new Functions.VHFRadioEncoder(this, VHF_AM_RADIO, BUTTON_11, BUTTON_12, "140", 0.1d, 0.0d, 0.9d, "VHF AM Radio", "2nd Frequencey Selector", true, "%0.2f"), true);
            //AddFunction(new Functions.VHFRadioEncoder3(this, VHF_AM_RADIO, BUTTON_13, BUTTON_14, "141", 0.1d, 0.0d, 0.9d, "VHF AM Radio", "3rd Frequencey Selector", true, "%0.2f"), true);
            //AddFunction(new Functions.VHFRadioEncoder4(this, VHF_AM_RADIO, BUTTON_15, BUTTON_16, "142", 0.25d, 0.0d, 0.9d, "VHF AM Radio", "4th Frequency Selector", true, "%0.2f"), true);
            //#endregion

            //#region VHF FM Radio
            //AddFunction(new Functions.VHFPresetSelector(this, VHF_FM_RADIO, BUTTON_2, BUTTON_1, "151", 0.01d, 0.00d, 0.19d, "VHF FM Radio", "Preset Channel Selector", true, "%0.3f"));
            //AddFunction(new Functions.VHFRadioEncoder1(this, VHF_FM_RADIO, BUTTON_9, BUTTON_10, "153", 0.05d, 0.15d, 0.75d, "VHF FM Radio", "1st Frequency Selector", false, "%0.2f"));
            //AddFunction(new Functions.VHFRadioEncoder(this, VHF_FM_RADIO, BUTTON_11, BUTTON_12, "154", 0.1d, 0.0d, 0.9d, "VHF FM Radio", "2nd Frequency Selector", true, "%0.2f"));
            //AddFunction(new Functions.VHFRadioEncoder3(this, VHF_FM_RADIO, BUTTON_13, BUTTON_14, "155", 0.1d, 0.0d, 0.9d, "VHF FM Radio", "3rd Frequency Selector", true, "%0.2f"));
            //AddFunction(new Functions.VHFRadioEncoder4(this, VHF_FM_RADIO, BUTTON_15, BUTTON_16, "156", 0.25d, 0.0d, 0.9d, "VHF FM Radio", "4th Frequency Selector", true, "%0.2f"));
            ...
            //AddFunction(Switch.CreateRotarySwitch(this, IFF, BUTTON_13, "199", "IFF", "Code", "%0.1f", "0.0", "Zero", "0.1", "B", "0.2", "A", "0.3", "Hold"));
            //AddFunction(Switch.CreateRotarySwitch(this, IFF, BUTTON_14, "200", "IFF", "Master Mode", "%0.1f", "0.0", "Off", "0.1", "Standby", "0.2", "Low", "0.3", "Normal", "0.4", "Emergency"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFF, BUTTON_15, "201", "1", "Audio", "0", "Out", "-1", "Light", "IFF", "Audio Light Switch", "%1d"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFF, BUTTON_16, "202", "1", "Test", "0", "On", "-1", "Out", "IFF", "M-1 Switch", "%1d"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFF, BUTTON_17, "203", "1", "Test", "0", "On", "-1", "Out", "IFF", "M-2 Switch", "%1d"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFF, BUTTON_18, "204", "1", "Test", "0", "On", "-1", "Out", "IFF", "M-3/A Switch", "%1d"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFF, BUTTON_19, "205", "1", "Test", "0", "On", "-1", "Out", "IFF", "M-C Switch", "%1d"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFF, BUTTON_20, "206", "1", "Test", "0", "Out", "-1", "Monitor", "IFF", "RAD Test/Monitor Switch", "%1d"));
            //AddFunction(Switch.CreateThreeWaySwitch(this, IFF, BUTTON_21, "207", "1", "Ident", "0", "Out", "-1", "Mic", "IFF", "Ident/Mic Switch", "%1d"));
            //AddFunction(Switch.CreateToggleSwitch(this, IFF, BUTTON_22, "208", "1", "On", "0", "Out", "IFF", "IFF On/Out", "%1d"));
            //AddFunction(new AbsoluteEncoder(this, IFF, BUTTON_1, BUTTON_2, "209", 0.1d, 0.0d, 0.9d, "IFF", "Mode 1 Wheel 1", true, "%0.2f"));
            //AddFunction(new AbsoluteEncoder(this, IFF, BUTTON_3, BUTTON_4, "210", 0.1d, 0.0d, 0.9d, "IFF", "Mode 1 Wheel 2", true, "%0.2f"));
            //AddFunction(new AbsoluteEncoder(this, IFF, BUTTON_5, BUTTON_6, "211", 0.1d, 0.0d, 0.9d, "IFF", "Mode 3/A Wheel 1", true, "%0.2f"));
            //AddFunction(new AbsoluteEncoder(this, IFF, BUTTON_7, BUTTON_8, "212", 0.1d, 0.0d, 0.9d, "IFF", "Mode 3/A Wheel 2", true, "%0.2f"));
            //AddFunction(new AbsoluteEncoder(this, IFF, BUTTON_9, BUTTON_10, "213", 0.1d, 0.0d, 0.9d, "IFF", "Mode 3/A Wheel 3", true, "%0.2f"));
            //AddFunction(new AbsoluteEncoder(this, IFF, BUTTON_11, BUTTON_12, "214", 0.1d, 0.0d, 0.9d, "IFF", "Mode 3/A Wheel 4", true, "%0.2f"));
            ...
            //AddFunction(Switch.CreateRotarySwitch(this, INTERCOM, BUTTON_19, "239", "Intercom", "Transmitter Select Dial", "%0.1f", "0.0", "Intercom", "0.1", "FM", "0.2", "VHF", "0.3", "HF"));
