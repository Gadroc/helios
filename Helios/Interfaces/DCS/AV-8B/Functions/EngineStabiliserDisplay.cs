...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.AV8B.Functions
{
    ...
    public class EngineStabiliserDisplay : NetworkFunction
    {
        private static DCSDataElement[] _dataElements = new DCSDataElement[] { new DCSDataElement("2005", null, false) };
        ...
        public EngineStabiliserDisplay(BaseUDPInterface sourceInterface)
            : base(sourceInterface)
        {
            _two_digit_display = new HeliosValue(sourceInterface, BindingValue.Empty, "EDP", "Stabiliser display", "Amount of Stabiliser", "", BindingValueUnits.Numeric);
