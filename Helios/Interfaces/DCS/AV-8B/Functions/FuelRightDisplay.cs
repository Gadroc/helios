...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.AV8B.Functions
{
    ...
    public class FuelRightDisplay : NetworkFunction
    {
        private static DCSDataElement[] _dataElements = new DCSDataElement[] { new DCSDataElement("2012", null, false) };

        private HeliosValue _four_digit_display;

        public FuelRightDisplay(BaseUDPInterface sourceInterface)
            : base(sourceInterface)
        {
            _four_digit_display = new HeliosValue(sourceInterface, BindingValue.Empty, "FQIS", "Right Tank display", "Fuel right tank quantity", "", BindingValueUnits.Numeric);
        ...
        public override void ProcessNetworkData(string id, string value)
        {
                    ...
                    _four_digit_display.SetValue(new BindingValue(displayvalue), false);
        }
