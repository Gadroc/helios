...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.Generic
{
    ...
    public partial class GenericInterfaceEditor : HeliosInterfaceEditor
    {
        ...
        {
            Type ownerType = typeof(GenericInterfaceEditor);
        ...
        {
            GenericInterfaceEditor editor = target as GenericInterfaceEditor;
        ...
        {
            InitializeComponent();
            Configuration = new DCSConfigurator("DCSGeneric", DCSPath);
            Configuration.ExportConfigPath = "Config\\Export";
            Configuration.ExportFunctionsPath = "pack://application:,,,/Helios;component/Interfaces/DCS/Generic/ExportFunctions.lua";
        }
        ...
        public static readonly DependencyProperty ConfigurationProperty =
            DependencyProperty.Register("Configuration", typeof(DCSConfigurator), typeof(GenericInterfaceEditor), new PropertyMetadata(null));
        ...
        public string DCSPath
        {
            get
            {
                if (_dcsPath == null)
                {
                    ...
                    if (pathKey == null)
                    {
                        pathKey = Registry.CurrentUser.OpenSubKey(@"Software\Eagle Dynamics\DCS Generic");
                    }
