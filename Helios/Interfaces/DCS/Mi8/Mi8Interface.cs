...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.Mi8
{
    ...
    //using GadrocsWorkshop.Helios.Interfaces.DCS.Mi8.Functions;
    using GadrocsWorkshop.Helios.Interfaces.DCS.Common;
    using GadrocsWorkshop.Helios.UDPInterface;
    using Microsoft.Win32;
    using System;

    [HeliosInterface("Helios.Mi8", "DCS Mi-8", typeof(Mi8InterfaceEditor), typeof(UniqueHeliosInterfaceFactory))]
    public class Mi8Interface : BaseUDPInterface
    {
            ...
            : base("DCS Mi-8")
        {
            ...
            config.ExportFunctionsPath = "pack://application:,,,/Helios;component/Interfaces/DCS/Mi8/ExportFunctions.lua";
            Port = config.Port;
        ...
        private string DCSPath
        {
            get
            {
                if (_dcsPath == null)
                {
                    RegistryKey pathKey = Registry.CurrentUser.OpenSubKey(@"Software\Eagle Dynamics\DCS Mi8");
                    if (pathKey != null)
                    {
