...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.Mi8
{
    ...
    /// <summary>
    /// Interaction logic for GenericInterfaceEditor.xaml
    /// </summary>
    public partial class Mi8InterfaceEditor : HeliosInterfaceEditor
    {
        static Mi8InterfaceEditor()
        {
            Type ownerType = typeof(Mi8InterfaceEditor);
        ...
        {
            Mi8InterfaceEditor editor = target as Mi8InterfaceEditor;
        ...
        public Mi8InterfaceEditor()
        {
            InitializeComponent();
            Configuration = new DCSConfigurator("DCSMi8", DCSPath);
            Configuration.ExportConfigPath = "Config\\Export";
            Configuration.ExportFunctionsPath = "pack://application:,,,/Helios;component/Interfaces/DCS/Mi8/ExportFunctions.lua";
        }
        ...
        public static readonly DependencyProperty ConfigurationProperty =
            DependencyProperty.Register("Configuration", typeof(DCSConfigurator), typeof(Mi8InterfaceEditor), new PropertyMetadata(null));
        ...
        public string DCSPath
        {
            get
            {
                if (_dcsPath == null)
                {
                    ...
                    if (pathKey == null)
                    {
                        pathKey = Registry.CurrentUser.OpenSubKey(@"Software\Eagle Dynamics\DCS Mi8");
                    }
                    ...
                    if (pathKey != null)
                    {
                        ...
                        pathKey.Close();
                        ConfigManager.LogManager.LogDebug("DCS Mi-8 Interface Editor - Found DCS Path (Path=\"" + _dcsPath + "\")");
                    }
                    else
                    {
                        _dcsPath = "";
        ...
        private void Configure_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show(Window.GetWindow(this), "DCS Mi-8 has been configured.");
            }
            else
            {
                MessageBox.Show(Window.GetWindow(this), "Error updating DCS Mi-8 configuration.  Please do one of the following and try again:\n\nOption 1) Run Helios as Administrator\nOption 2) Install DCS outside the Program Files Directory\nOption 3) Disable UAC.");
            }
        }
