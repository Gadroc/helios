...
namespace GadrocsWorkshop.Helios.Controls
{
    ...
    [HeliosControl("Helios.Base.RotarySwitchPushable", "Pushable Rotary - Knob 2", "Rotary Switches", typeof(RotarySwitchRenderer))]
    public class RotarySwitchPushable : HeliosVisual
    {
