...
namespace GadrocsWorkshop.Helios.Controls
{
    ...
    /// <summary>
    /// Interaction logic for IndicatorPushButtonAppearanceEditor.xaml
    /// </summary>
    [HeliosPropertyEditor("Helios.Base.IndicatorPushButton", "Appearance")]
    public partial class IndicatorPushButtonAppearanceEditor : HeliosPropertyEditor
    {
        public IndicatorPushButtonAppearanceEditor()
        {
            InitializeComponent();
        }
